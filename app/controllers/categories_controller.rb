class CategoriesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @category.update(category_params)
        format.html { redirect_to product_variants_path, notice: "Category was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to product_variants_path, status: :see_other, notice: "Category was successfully destroyed." }

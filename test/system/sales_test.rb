...
class SalesTest < ApplicationSystemTestCase
  ...
  test "should create sale" do
    ...
    fill_in "Realization datetime", with: @sale.realization_datetime
    fill_in "Total sale", with: @sale.total_sale
  ...
  test "should update Sale" do
    ...
    fill_in "Client", with: @sale.client
    fill_in "Deleted at", with: @sale.deleted_at
    fill_in "Realization datetime", with: @sale.realization_datetime.to_s
    fill_in "Total sale", with: @sale.total_sale
    fill_in "User", with: @sale.user_id
